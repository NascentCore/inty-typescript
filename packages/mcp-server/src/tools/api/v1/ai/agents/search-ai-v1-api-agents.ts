...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/v1/ai/agents/search',
  operationId: 'search_agents_api_v1_ai_agents_search_get',
};

export const tool: Tool = {
  name: 'search_ai_v1_api_agents',
  description:
...
export const handler = async (client: Inty, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.api.v1.ai.agents.search(body)));
};
