...
export const metadata: Metadata = {
  ...
  operationId: 'follow_agent_api_v1_ai_agents__agent_id__follow_post',
};

export const tool: Tool = {
  name: 'follow_agent_ai_v1_api_agents',
  description:
...
export const handler = async (client: Inty, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.api.v1.ai.agents.followAgent(agent_id)),
  );
};
