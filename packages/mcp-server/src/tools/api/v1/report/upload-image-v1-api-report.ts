...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/api/v1/report/upload-image',
  operationId: 'upload_report_image_api_v1_report_upload_image_post',
};

export const tool: Tool = {
  name: 'upload_image_v1_api_report',
  description:
...
export const handler = async (client: Inty, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.api.v1.report.uploadImage(body)));
};
