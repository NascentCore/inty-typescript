...
export const metadata: Metadata = {
  ...
  operationId: 'update_settings_endpoint_api_v1_settings__put',
};

export const tool: Tool = {
  name: 'update_v1_api_settings',
  description:
...
export const handler = async (client: Inty, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.api.v1.settings.update(body)));
};
