...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['google_play_product_id', 'name', 'plan_type', 'price'],
    $defs: {
      subscription_plan_type: {
        type: 'string',
        title: 'SubscriptionPlanType',
...
export const handler = async (client: Inty, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.api.v1.subscription.admin.plans.create(body)),
  );
};
