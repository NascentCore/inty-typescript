...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/v1/subscription/usage',
  operationId: 'get_usage_statistics_api_v1_subscription_usage_get',
};

export const tool: Tool = {
  name: 'get_usage_v1_api_subscription',
  description:
...
export const handler = async (client: Inty, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.api.v1.subscription.getUsage()));
};
